...
async function handleIdleState(user, text) {
    ...
    if (intent === INTENTS.GENERAL_CONVERSATION) {
        // Use the reply generated by AI (Context aware: "What can you do?" -> "I can log sales...")
        ...
        // We do NOT send main menu here to keep it conversational, unless user asks for help.
        return;
    } 
    
    if (intent === INTENTS.CHITCHAT) {
        // Fallback for simple hellos if not caught by GENERAL_CONVERSATION
