...
// [CRITICAL FIX] Enforce Nigeria Time (Africa/Lagos)
const formatDateTime = (dateInput) => {
    ...
    return new Intl.DateTimeFormat('en-GB', {
        ...
        minute: '2-digit',
        hour12: true,
        timeZone: 'Africa/Lagos' // Forces Nigeria Time
    }).format(date);
};

// [CRITICAL FIX] Enforce Nigeria Date
const formatDate = (dateInput) => {
    ...
    return new Intl.DateTimeFormat('en-GB', {
        ...
        month: '2-digit',
        year: 'numeric',
        timeZone: 'Africa/Lagos' // Forces Nigeria Date (handles late night overlap)
    }).format(date);
};

const drawFooter = (doc) => {
    const range = doc.bufferedPageRange(); 
    const timestamp = formatDateTime(new Date()); // Will now show correct WAT time
